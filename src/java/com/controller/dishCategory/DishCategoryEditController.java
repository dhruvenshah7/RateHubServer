...
/**
 * Servlet implementation class DishCategoryEditController
 */
@WebServlet("/DishCategoryEditController")
public class DishCategoryEditController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DishCategoryEditController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DishCategoryBean bean = dao.editData(id);
